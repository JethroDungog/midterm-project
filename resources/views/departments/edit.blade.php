                ...
                <div class="card-body theme-bg text-theme">
                    <form action="{{ route('departments.update', $department->DepartmentID) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('DepartmentName') is-invalid @enderror theme-bg text-theme" id="DepartmentName" name="DepartmentName" value="{{ old('DepartmentName', $department->DepartmentName) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('DepartmentCode') is-invalid @enderror theme-bg text-theme" id="DepartmentCode" name="DepartmentCode" value="{{ old('DepartmentCode', $department->DepartmentCode) }}" required>
